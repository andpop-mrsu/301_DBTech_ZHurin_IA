    ...
    <div class="container">
        ...
        <?php if ($subAction === "create" || $subAction === "edit"): ?>
            ...
            <form method="POST" class="form">
                <?php if ($subAction === "edit"): ?>
                    <input type="hidden" name="id" value="<?= html($service["id"]) ?>">
                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="client_first_name" value="<?= html($service["client_first_name"] ?? "") ?>" required>
                </div>
                <div class="form-group">
                    <label>Фамилия клиента *</label>
                    <input type="text" name="client_last_name" value="<?= html($service["client_last_name"] ?? "") ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" id="price_input" step="0.01" min="0" value="<?= html($service["fixed_price"] ?? "") ?>" required>
                </div>
        ...
        <?php elseif ($subAction === "delete"): ?>
            <div class="confirmation">
                ...
                <p>Вы действительно хотите удалить запись от <?= formatDateTime($service["start_datetime"]) ?> (услуги: "<?= html($service["services_list"]) ?>")?</p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            <td><?= formatDateTime($service["start_datetime"]) ?></td>
                            <td><?= html($service["services_list"]) ?></td>
                            <td><?= html($service["duration_min"]) ?></td>
